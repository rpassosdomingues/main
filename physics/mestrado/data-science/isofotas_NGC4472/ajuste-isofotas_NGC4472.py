...
def main(argv=None):
    ...
    imageFile = "NGC4472_SDSSr.fits.bz2"
    # https://vizier.u-strasbg.fr/viz-bin/VizieR-4
    # http://skyserver.sdss.org/dr8/en/tools/explore/obj.asp?ra=187.4458&dec=8.0003
    # RA: 187.4458 deg / DEC: 8.0003 deg
    # http://simbad.u-strasbg.fr/simbad/sim-basic?Ident=NGC+4472&submit=SIMBAD+search
    # https://ned.ipac.caltech.edu/byname?objname=NGC+4472&hconst=67.8&omegam=0.308&omegav=0.692&wmap=4&corr_z=1
