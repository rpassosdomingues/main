...
def main(argv=None):
    ...
    imageFile = "NGC5628_SDSSr.fits.bz2"
    # https://vizier.u-strasbg.fr/viz-bin/VizieR-4
    # http://skyserver.sdss.org/dr8/en/tools/explore/obj.asp?ra=217.1083&dec=17.9253
    # 153	14 28 26.088	+17 55 31.12	14 28 26.0	+17 55 31	NGC 5628	.E.....	-5.0	14.33	5632
    # RA: 217.1083 deg / DEC: 17.9253 deg
    # http://simbad.u-strasbg.fr/simbad/sim-basic?Ident=NGC+5628&submit=SIMBAD+search
    # https://ned.ipac.caltech.edu/byname?objname=NGC+5628&hconst=67.8&omegam=0.308&omegav=0.692&wmap=4&corr_z=1
